...
public class EnrichLoanKafkaStream {
    ...
    public void startStream() {
        ...
        streamBuilder.stream(KafkaTopic.ENRICHED_LOANS.getTopicName(), kafkaHelper.consumedWith(EnrichLoanEvent.class))
                .foreach(this::save);
    ...
    private void save(String key, EnrichLoanEvent event) {
        LOGGER.info("Received event with key {} on topic {}", key, KafkaTopic.ENRICHED_LOANS.getTopicName());
